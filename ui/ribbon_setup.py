...
class RibbonMixin:
    ...
    def _setup_ribbon_tabs(self):
        ...
        m_layout.addWidget(self.create_ribbon_btn("Yan Yana\nGörüntüle", "İki değişken grubunu yan yana kıyasla.", self._show_side_by_side, "⚖️", COLORS['primary_600']))
        ...
        h_l.addWidget(self.create_ribbon_btn("Güncelleme\nKontrolü", "Yeni bir sürüm olup olmadığını kontrol edin.", self._check_updates, "🔄", COLORS['primary_600']))
